...
label3.caption:='2+2';
  ...
  label3.Top:=352;
    ...
    if n=4 then
      begin
            image2.Visible:=true;
            label2.Caption:='Відповідь правильна. Очікуйте запуск ракети на орбіту.';
            label2.Visible:=true;
            for c1:=1 to 6300 do
        ...
        begin
          label2.Caption:='Відповідь неправильна або Ви дали жодної відповіді. Очікуйте запуск ракети';
          label2.Visible:=true;
        end;
        end;
    if i=2 then
  ...
  label3.Top:=352;
    ...
    if n=6 then
      begin
        ...
        begin
          label2.Caption:='На жаль, Ви програли. Очікуйте наступний раунд.';
          label2.Visible:=true;
        end;
        end;
            if i=4 then
...
label3.caption:='11111+3333';
  ...
  label3.Top:=352;
    ...
    if n=8 then
      begin
            image2.Visible:=true;
            label2.Caption:='Ответ правильный. Ожидайте запуска ракеты.';
            label2.Visible:=true;
            for c1:=1 to 6300 do
              if (image3.top>-130)and(n=8) then
                ...
                begin
                  image3.Visible:=false;
                  image2.Visible:=false;
                  label2.caption:='Гра завершена! :P';
                end;
